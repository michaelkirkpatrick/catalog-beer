...
<body>
    ...
    <div class="container-fluid">
        <?php
            ...
            <script>
            function initMap() {
                // JSON_HEX_TAG is the load-bearing flag: these carry raw brewer and
                // location names, and inside a <script> the parser is looking for
                // "<", not for quotes. Default json_encode escapes "/", so the
