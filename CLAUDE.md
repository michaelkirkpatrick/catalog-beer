...
- **`config/passwords.php`** — Secrets (DB passwords, API keys, tokens). **Never committed or deployed** — lives on each server, managed manually. Copy `passwords.example.php` to create it.
