...
// HTML Head
$htmlHead = new htmlHead('Privacy Policy: Catalog.beer');
echo $htmlHead->html;
?>
<body>
	<?php
	...
	<div class="container">
		<div class="row">
    		...
    		<h1>Privacy Policy</h1>
				...
				<p>Last updated on October 30, 2018</p>
				...
				<p>When you create an Catalog.beer account, pay API fees, or contact us, we may collect a variety of information, including your name, credit card information, and email address.</p>
