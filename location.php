...
$perms = $loggedIn ? brewerPermissions($api, $locationData->brewer->id) : null;
$canEditLocation = permissionsCanEdit($perms, !empty($locationData->cb_verified), !empty($locationData->brewer_verified));
$canDeleteLocation = permissionsCanManage($perms);
